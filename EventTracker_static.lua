...
ET_Static = {
    ...
    ["CHAT_MSG_COMBAT_XP_GAIN"] = ["CHAT_MSG_COMBAT_XP_GAIN"] = {"Message", "Name1", "Language", "Channel", "Name2", "specialFlags", "zoneChannelID", "channelIndex", "channelBaseName",
    ...
    ["CHAT_MSG_MONSTER_SAY"] = {"Message","Sender","Language","Channel","Triggered by"},
    ...
    ["COMBAT_LOG_EVENT"] = {"Timestamp","Event","Hidden","Source GUID","Source name","Source flags","Source Raid Flags","Destination GUID","Destination name","Destination flags","Destination raid flags",
        "Arg 12","Arg 13","Arg 14","Arg 15","Arg 16","Arg 17","Arg 18","Arg 19","Arg 20","Arg 21","Arg 22","Arg 23","Arg 24"},
    ["COMBAT_LOG_EVENT_UNFILTERED"] = {"Timestamp","Event","Hidden","Source GUID","Source name","Source flags","Source Raid Flags","Destination GUID","Destination name","Destination flags","Destination raid flags",
        "Arg 12","Arg 13","Arg 14","Arg 15","Arg 16","Arg 17","Arg 18","Arg 19","Arg 20","Arg 21","Arg 22","Arg 23","Arg 24"},
    ...
    ["PLAYER_LEVEL_UP"] = {"New level","HP Increase","Power Increase","Talent points","PVP Talent Points","Strength","Agility","Stamina","Intellect"},
    ...
    ["UNIT_AURA"] = {"Unit ID", "Updated Auras"},
    ...
    ["UNIT_SPELLCAST_CHANNEL_START"] = {"Unit ID","Cast GUID","Spell ID"},
    ["UNIT_SPELLCAST_CHANNEL_STOP"] = {"Unit ID","Cast GUID","Spell ID"},
    ["UNIT_SPELLCAST_CHANNEL_UPDATE"] = {"Unit ID","Cast GUID","Spell ID"},
    ["UNIT_SPELLCAST_DELAYED"] = {"Unit ID","Cast GUID","Spell ID"},
    ["UNIT_SPELLCAST_FAILED"] = {"Unit ID","Cast GUID","Spell ID"},
    ["UNIT_SPELLCAST_FAILED_QUIET"] = {"Unit ID","Cast GUID","Spell ID"},
    ["UNIT_SPELLCAST_INTERRUPTED"] = {"Unit ID","Cast GUID","Spell ID"},
    ["UNIT_SPELLCAST_SENT"] = {"Player","Target","Cast GUID","Spell ID"},
    ["UNIT_SPELLCAST_START"] = {"Unit ID","Cast GUID","Spell ID"},
    ["UNIT_SPELLCAST_STOP"] = {"Unit ID","Cast GUID","Spell ID"},
    ["UNIT_SPELLCAST_SUCCEEDED"] = {"Unit ID","Cast GUID","Spell ID"},
